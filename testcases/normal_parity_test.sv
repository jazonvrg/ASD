class normal_parity_test extends uart_base_test;
	`uvm_component_utils(normal_parity_test)
	...
	function new(string name = "normal_parity_test", uvm_component parent);
		...
		foreach(prt_mode[i_prt]) begin
			foreach(dt_width[i_dt]) begin
				foreach(stp_bit[i_stp]) begin
					foreach(ovs[i_ovs]) begin
						$display("============================================================================================================================");
						$display("=================================================  ### NORMAL PARITY  ###  =================================================");
						$display("============================================================================================================================");
