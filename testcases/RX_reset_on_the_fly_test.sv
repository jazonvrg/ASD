class RX_reset_on_the_fly_test extends uart_base_test;
	`uvm_component_utils(RX_reset_on_the_fly_test)
	...
	function new(string name = "RX_reset_on_the_fly_test", uvm_component parent);
