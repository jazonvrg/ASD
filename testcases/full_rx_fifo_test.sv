class full_rx_fifo_test extends uart_base_test;
	`uvm_component_utils(full_rx_fifo_test)
	...
	function new(string name = "full_rx_fifo_test", uvm_component parent);
