class TX_16x_9600_baud_test extends uart_base_test;
	`uvm_component_utils(TX_16x_9600_baud_test)
	...
	function new(string name = "TX_16x_9600_baud_test", uvm_component parent);
