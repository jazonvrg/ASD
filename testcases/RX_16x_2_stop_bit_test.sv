class RX_16x_2_stop_bit_test extends uart_base_test;
	`uvm_component_utils(RX_16x_2_stop_bit_test)
	...
	function new(string name = "RX_16x_2_stop_bit_test", uvm_component parent);
