class RX_16x_custom_baud_test extends uart_base_test;
	`uvm_component_utils(RX_16x_custom_baud_test)
	...
	function new(string name = "RX_16x_custom_baud_test", uvm_component parent);
