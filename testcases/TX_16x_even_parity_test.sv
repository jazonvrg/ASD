class TX_16x_even_parity_test extends uart_base_test;
	`uvm_component_utils(TX_16x_even_parity_test)
	...
	function new(string name = "TX_16x_even_parity_test", uvm_component parent);
