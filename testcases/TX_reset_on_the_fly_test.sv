class TX_reset_on_the_fly_test extends uart_base_test;
	`uvm_component_utils(TX_reset_on_the_fly_test)
	...
	function new(string name = "TX_reset_on_the_fly_test", uvm_component parent);
