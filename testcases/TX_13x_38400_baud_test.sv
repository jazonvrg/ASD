class TX_13x_38400_baud_test extends uart_base_test;
	`uvm_component_utils(TX_13x_38400_baud_test)
	...
	function new(string name = "TX_13x_38400_baud_test", uvm_component parent);
