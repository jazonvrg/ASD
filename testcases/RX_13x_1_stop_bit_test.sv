class RX_13x_1_stop_bit_test extends uart_base_test;
	`uvm_component_utils(RX_13x_1_stop_bit_test)
	...
	function new(string name = "RX_13x_1_stop_bit_test", uvm_component parent);
