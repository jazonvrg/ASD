class TX_16x_5bits_data_test_cp extends uart_base_test;
	`uvm_component_utils(TX_16x_5bits_data_test_cp)
	...
	function new(string name = "TX_16x_5bits_data_test_cp", uvm_component parent);
