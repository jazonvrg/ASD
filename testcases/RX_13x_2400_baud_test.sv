class RX_13x_2400_baud_test extends uart_base_test;
	`uvm_component_utils(RX_13x_2400_baud_test)
	...
	function new(string name = "RX_13x_2400_baud_test", uvm_component parent);
