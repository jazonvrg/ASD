class TX_16x_1_stop_bit_test extends uart_base_test;
	`uvm_component_utils(TX_16x_1_stop_bit_test)
	...
	function new(string name = "TX_16x_1_stop_bit_test", uvm_component parent);
