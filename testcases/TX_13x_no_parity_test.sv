class TX_13x_no_parity_test extends uart_base_test;
	`uvm_component_utils(TX_13x_no_parity_test)
	...
	function new(string name = "TX_13x_no_parity_test", uvm_component parent);
