class RX_13x_odd_parity_test extends uart_base_test;
	`uvm_component_utils(RX_13x_odd_parity_test)
	...
	function new(string name = "RX_13x_odd_parity_test", uvm_component parent);
