class RX_16x_odd_parity_test extends uart_base_test;
	`uvm_component_utils(RX_16x_odd_parity_test)
	...
	function new(string name = "RX_16x_odd_parity_test", uvm_component parent);
