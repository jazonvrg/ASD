class error_parity_test_cp extends uart_base_test;
	`uvm_component_utils(error_parity_test_cp)
	...
	function new(string name = "error_parity_test_cp", uvm_component parent);
