class TX_13x_8bits_data_test extends uart_base_test;
	`uvm_component_utils(TX_13x_8bits_data_test)
	...
	function new(string name = "TX_13x_8bits_data_test", uvm_component parent);
